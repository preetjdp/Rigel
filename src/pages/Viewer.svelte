    ...
    run({
        ...
        contents: [
            ...
            },
            {
                ...
                params: {
                    text:
                        "This PDF document was generated dynamically in your browser. No server resources were utilized.",
                    font_name: "Helvetica-Bold",
                    font_size: 12,
                    align: "left",
                },
                                            ...
                                            contents: [
                                                {
                                                    ...
                                                    params: {
                                                        text:
                                                            "This is a Table defined in JSON",
                                                        align: "center",
                                                        font_name:
                                                            "Helvetica-Bold",
                                                    },
                                                },
                                                {
                                                    ...
                                                    params: {
                                                        text:
                                                            "Check out examples/text-example.json from this repository. It's easy to create content with JSON.",
                                                        font_size: 10,
                                                        leading: 10,
                                                        align: "center",
                                                    },
            ...
            },
            {
                ...
                params: {
                    text:
                        "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam maximus tincidunt nisl. Integer bibendum, leo sed lobortis mollis, orci ante vulputate velit, id ultricies diam mauris consequat neque. Integer et nibh lectus. Cras felis massa, vehicula eget consequat sit amet, bibendum et est.",
                    font_name: "Times",
                    font_size: 12,
                    bullet: "•",
                    bullet_indent: 12,
            ...
            },
            {
                ...
                params: {
                    text:
                        "Courier is fixed width font. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam maximus tincidunt nisl. Integer bibendum, leo sed lobortis mollis, orci ante vulputate velit, id ultricies diam mauris consequat neque. Integer et nibh lectus. Cras felis massa, vehicula eget consequat sit amet, bibendum et est.",
                    font_name: "courier",
                    font_size: 12,
                    align: "left",
                },
            ...
            },
            {
                ...
                params: {
                    text:
                        "As you can see, this text flows dynamically to another page.",
                    font_size: 14,
                    align: "center",
                    font_name: "Helvetica-Bold",
                },
            },
            {
                ...
                params: {
                    text:
                        "After this paragraph, comes a 100 point spacer element.",
                    font_size: 14,
                    align: "center",
                    font_name: "Helvetica-Bold",
                    color: [1, 0, 0],
